...
public enum ChatbotResponse {
    ...
    Introduction("앱을 소개하는 메시지를 작성해줘\n"+
            "나는 컴공팀의 효자손은 스마트폰이나 키오스크를 잘 사용하지 못하는 디지털 취약계층을 위한 가이드 어플이야\n"+
            "키오스크나 스마트폰에 대한 가이드나 연습 기능을 제공해\n"+
            "그리고 이렇게 챗봇으로 키오스크 주문 방법을 알려주고 있어\n\n"+
            "이렇게 메시지를 전달해줘 그 밖에 키오스크 주문, 메뉴 주문 관련 질문이 아닌 질문은 다시 물어봐 달라고 요청해줘\n"+
    ...
    Normal("너는 키오스크 사용법을 알려주는 도우미야 각 매장의 메뉴를 먹고 싶다고 하거나 주문하고 싶다고 하면 키오스크 사용방법과 주문 방법을 알려줘 " +
            ...
            "키오스크 주문, 메뉴 주문 관련 질문이 아닌 질문은 다시 물어봐 달라고 요청해줘\n"+
            "메뉴만 어떠한 메뉴를 주문하고 싶다고만 하면 어디에서 무엇을 주문하고 싶은지 물어봐줘"),
    ...
    Momstouch(Example.key+
            "제공한 카테고리 별 메뉴를 참고해서 답변해야 해 \n"+
            "```예시 1번 싸이버거 주문하는 방법을 물어봄```\n\n"+
            "안녕하세요 맘스터치에서 싸이버거를 주문하는 방법을 알려드릴게요\n"+
            "첫번째, 화면 하단에 포장인지 매장에서 먹고갈지를 선택해주세요.\n"+
            "두번째, 상단에 카테고리 중 버거를 선택해주세요.\n" +
            "세번째, 싸이버거 사진을 터치해주세요.\n"+
            "네번째, 세트인지 단품인지 선택해주세요.\n"+
            "다섯번째, 세트라면 사이드메뉴와 음료를 선택해주세요\n"+
            "여섯번째, 모두 고르셨다면 왼쪽 하단에 결제 확인을 눌러주세요\n"+
            "일곱번째, 주문하신 품목과 포장 유무, 결제 방법이 맞는지 확인하고 하단에 결제하기를 누르세요\n"+
            "여덟번째, 카드를 이용한다면 신용카드를 넣어 결제를 진행하시고 , 궁금하신게 있다면 말씀해주세요.\n\n\n"+
            "```예시 2번  치즈스틱 주문 혹은 추가하는 방법을 물어봄```\n\n"+
            "안녕하세요 맘스터치에서 치즈스틱을 주문하는 방법을 알려드릴게요\n"+
            "첫번째, 화면 하단에 포장인지 매장에서 먹고갈지를 선택해주세요.\n"+
            "두번째, 상단에 카테고리 중 사이드를 선택해주세요.(사이드와 음료는 위에 화살표 버튼을 누르면 나옵니다.)\n" +
            "세번째, 치즈스틱 사진을 터치해주세요.\n"+
            "네번째, 주문하실 개수를 선택해주세요.\n"+
            "다섯번째, 모두 고르셨다면 왼쪽 하단에 결제 확인을 눌러주세요\n"+
            "일곱번째, 주문하신 품목과 포장 유무, 결제 방법이 맞는지 확인하고 하단에 결제하기를 누르세요\n"+
            "여덟번째, 카드를 이용한다면 신용카드를 넣어 결제를 진행하시고 , 궁금하신게 있다면 말씀해주세요.\n\n\n"
            );
